...
static gboolean nle_object_prepare_func (GnlObject * object);
static gboolean nle_object_cleanup_func (GnlObject * object);
static gboolean nle_object_commit_func (GnlObject * object, gboolean recurse);

static GstStateChangeReturn nle_object_prepare (GnlObject * object);

static void
nle_object_class_init (GnlObjectClass * klass)
{
...
static void
nle_object_init (GnlObject * object, GnlObjectClass * klass)
{
...
{
  GnlObject *nle = (GnlObject *) object;
 ...
 */
gboolean
nle_object_to_media_time (GnlObject * object, GstClockTime otime,
    GstClockTime * mtime)
{
...
gboolean
nle_media_to_object_time (GnlObject * object, GstClockTime mtime,
    GstClockTime * otime)
{
...
static gboolean
nle_object_prepare_func (GnlObject * object)
{
...
nle_object_prepare (GnlObject * object)
{
...
static gboolean
nle_object_cleanup_func (GnlObject * object)
{
...
nle_object_cleanup (GnlObject * object)
{
  GstStateChangeReturn ret = GST_STATE_CHANGE_SUCCESS;
...
void
nle_object_set_caps (GnlObject * object, const GstCaps * caps)
{
  if (object->caps)
...
static inline void
_update_stop (GnlObject * nleobject)
{
...
static gboolean
nle_object_commit_func (GnlObject * object, gboolean recurse)
{
...
nle_object_set_property (GObject * object, guint prop_id,
    const GValue * value, GParamSpec * pspec)
{
  GnlObject *nleobject = (GnlObject *) object;
  ...
  switch (prop_id) {
    ...
    case PROP_EXPANDABLE:
      if (g_value_get_boolean (value))
        GST_OBJECT_FLAG_SET (nleobject, GNL_OBJECT_EXPANDABLE);
      else
        GST_OBJECT_FLAG_UNSET (nleobject, GNL_OBJECT_EXPANDABLE);
      break;
    default:
...
nle_object_change_state (GstElement * element, GstStateChange transition)
{
  ...
  switch (transition) {
      ...
      if (parent) {
        if (g_strcmp0 (gst_element_get_name (GST_ELEMENT (parent)),
          ...
          GST_INFO ("Adding nleobject to something that is not a composition,"
              " commiting ourself");
          nle_object_commit (GNL_OBJECT (element), FALSE);
        }
    ...
    case GST_STATE_CHANGE_READY_TO_PAUSED:
      if (nle_object_prepare (GNL_OBJECT (element)) == GST_STATE_CHANGE_FAILURE) {
        ret = GST_STATE_CHANGE_FAILURE;
        goto beach;
      }
      break;
  ...
  switch (transition) {
    case GST_STATE_CHANGE_PAUSED_TO_READY:
      /* cleanup nleobject */
      if (nle_object_cleanup (GNL_OBJECT (element)) == GST_STATE_CHANGE_FAILURE)
        ret = GST_STATE_CHANGE_FAILURE;
      break;
    default:
      break;
...
void
nle_object_set_commit_needed (GnlObject * object)
{
...
gboolean
nle_object_commit (GnlObject * object, gboolean recurse)
{
  gboolean ret;
...
void
nle_object_reset (GnlObject * object)
{
