 ...
 *
 * nleoperation.h: Header for base GnlOperation
 *
...
void
nle_operation_signal_input_priority_changed(GnlOperation * operation, GstPad *pad,
					    guint32 priority);

void nle_operation_update_base_time (GnlOperation *operation,
                                     GstClockTime timestamp);

void nle_operation_hard_cleanup (GnlOperation *operation);
