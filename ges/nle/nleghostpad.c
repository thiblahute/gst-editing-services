...
GstEvent *
nle_object_translate_incoming_seek (GnlObject * object, GstEvent * event)
{
  GstEvent *event2;
  GstFormat format;
  gdouble rate;
 ...
 */
GstPad *
nle_object_ghost_pad (GnlObject * object, const gchar * name, GstPad * target)
{
 ...
 */
GstPad *
nle_object_ghost_pad_no_target (GnlObject * object, const gchar * name,
...
void
nle_object_remove_ghost_pad (GnlObject * object, GstPad * ghost)
{
  GnlPadPrivate *priv;
...
gboolean
nle_object_ghost_pad_set_target (GnlObject * object, GstPad * ghost,
    GstPad * target)
{
