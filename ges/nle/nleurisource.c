...
G_DEFINE_TYPE_WITH_CODE (GnlURISource, nle_urisource, GNL_TYPE_SOURCE,
    _do_init);
...
static gboolean nle_urisource_prepare (GnlObject * object);
...
static void
nle_urisource_class_init (GnlURISourceClass * klass)
{
...
static void
nle_urisource_init (GnlURISource * urisource)
{
...
static inline void
nle_urisource_set_uri (GnlURISource * fs, const gchar * uri)
{
...
static gboolean
nle_urisource_prepare (GnlObject * object)
{
