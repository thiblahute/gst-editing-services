...
extern GType ges_track_type_get_type(void);
extern GType ges_meta_flag_get_type(void);
extern GType ges_video_standard_transition_type_get_type(void);
extern GType ges_text_valign_get_type(void);
extern GType ges_text_halign_get_type(void);
extern GType ges_video_test_pattern_get_type(void);
extern GType ges_pipeline_flags_get_type(void);
extern GType ges_edit_mode_get_type(void);
extern GType ges_edge_get_type(void);
extern GType ges_timeline_get_type(void);
extern GType ges_layer_get_type(void);
extern GType ges_timeline_element_get_type(void);
extern GType ges_track_get_type(void);
extern GType ges_container_get_type(void);
extern GType ges_clip_get_type(void);
extern GType ges_pipeline_get_type(void);
extern GType ges_source_clip_get_type(void);
extern GType ges_test_clip_get_type(void);
extern GType ges_title_clip_get_type(void);
extern GType ges_operation_clip_get_type(void);
extern GType ges_base_effect_clip_get_type(void);
extern GType ges_overlay_clip_get_type(void);
extern GType ges_text_overlay_clip_get_type(void);
extern GType ges_base_transition_clip_get_type(void);
extern GType ges_transition_clip_get_type(void);
extern GType ges_effect_clip_get_type(void);
extern GType ges_uri_clip_get_type(void);
extern GType ges_group_get_type(void);
extern GType ges_asset_get_type(void);
extern GType ges_clip_asset_get_type(void);
extern GType ges_track_element_asset_get_type(void);
extern GType ges_uri_clip_asset_get_type(void);
extern GType ges_uri_source_asset_get_type(void);
extern GType ges_project_get_type(void);
extern GType ges_extractable_get_type(void);
extern GType ges_formatter_get_type(void);
extern GType ges_base_xml_formatter_get_type(void);
extern GType ges_xml_formatter_get_type(void);
extern GType ges_track_element_get_type(void);
extern GType ges_source_get_type(void);
extern GType ges_operation_get_type(void);
extern GType ges_video_source_get_type(void);
extern GType ges_video_uri_source_get_type(void);
extern GType ges_audio_source_get_type(void);
extern GType ges_audio_uri_source_get_type(void);
extern GType ges_image_source_get_type(void);
extern GType ges_multi_file_source_get_type(void);
extern GType ges_video_test_source_get_type(void);
extern GType ges_audio_test_source_get_type(void);
extern GType ges_title_source_get_type(void);
extern GType ges_text_overlay_get_type(void);
extern GType ges_transition_get_type(void);
extern GType ges_video_transition_get_type(void);
extern GType ges_audio_transition_get_type(void);
extern GType ges_base_effect_get_type(void);
extern GType ges_effect_get_type(void);
extern GType ges_pitivi_formatter_get_type(void);
extern GType ges_command_line_formatter_get_type(void);
extern GType ges_meta_container_get_type(void);
extern GType ges_audio_track_get_type(void);
extern GType ges_video_track_get_type(void);
extern GType ges_effect_asset_get_type(void);
extern GType ges_smart_adder_get_type(void);
