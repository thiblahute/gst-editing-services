 ...
 * @track: a #GESTrack
 * @func: (scope notified): The #GESCreateElementForGapFunc that will be used to create #GstElement to
 * fill gaps
 *
 * Sets the function that should be used to create the GstElementused to fill gaps.
 * To avoid to provide such a function and handle gaps we advice you to use the
 * #ges_track_audio_raw_new and #ges_track_video_raw_new constructor when
 * possible.
 */
void
