...
ges_validate_register_action_types (void)
{
  ...
  gst_validate_add_action_type ("split-clip", "ges", _split_clip,
      (GstValidateActionParameter []) {
        {
          .name = "clip-name",
  ...
  gst_validate_add_action_type ("set-track-restriction-caps", "ges", _set_track_restriction_caps,
      (GstValidateActionParameter []) {
        {
          .name = "track-type",
  ...
  gst_validate_add_action_type ("element-set-asset", "ges", _set_asset_on_element,
      (GstValidateActionParameter []) {
        {
          .name = "element-name",
  ...
  gst_validate_add_action_type ("container-add-child", "ges", _container_add_child,
      (GstValidateActionParameter []) {
        {
          .name = "container-name",
  ...
  gst_validate_add_action_type ("container-remove-child", "ges", _container_remove_child,
      (GstValidateActionParameter []) {
        {
          .name = "container-name",
  ...
  gst_validate_add_action_type ("set-control-source", "ges", _set_control_source,
      (GstValidateActionParameter []) {
        {
          .name = "element-name",
  ...
  gst_validate_add_action_type ("add-keyframe", "ges", _add_remove_keyframe,
      (GstValidateActionParameter []) {
        {
          .name = "element-name",
  ...
  gst_validate_add_action_type ("remove-keyframe", "ges", _add_remove_keyframe,
      (GstValidateActionParameter []) {
        {
          .name = "element-name",
          .description = "The name of the GESTrackElement to add a keyframe on",
  ...
  gst_validate_add_action_type ("commit", "ges", _commit, NULL,
